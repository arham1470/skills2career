...
const Settings = () => {
  ...
  const handleDeleteAccount = async (e) => {
    ...
    setDeleting(true);
    try {
      await api.delete("/seeker/account", { data: { currentPassword: deletePassword } });
      logout();
      navigate("/");
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.put("/seeker/password", { currentPassword: form.currentPassword, newPassword: form.newPassword });
    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 border-t-4 border-t-red-500 p-6 shadow-sm">
        ...
        <p className="text-sm text-red-600/80 mb-4">
          Deleting your account will permanently remove all your data, including profile, applications, certificates, conversations, and messages. This action cannot be undone.
        </p>
        <Button
          variant="secondary"
